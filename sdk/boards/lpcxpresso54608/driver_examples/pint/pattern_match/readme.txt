...
2. This example configures "Pin Interrupt 0" to be invoked when SW2 switch is pressed by the user. 
   ...
   "Pin Interrupt 3" is configured to be invoked when rising edge on SW2, SW3 and SW4 is detected. The 
   ...
   "Pin Interrupt 6" is configured to be invoked when rising edge on SW2, low level on SW3 and SW4 is detected. 
